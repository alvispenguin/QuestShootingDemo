...
@onready var vignette_strength_slider: HSlider = $VBoxContainer/VignetteStrengthSlider
@onready var vignette_radius_slider: HSlider = $VBoxContainer/VignetteRadiusSlider
@onready var vignette_softness_slider: HSlider = $VBoxContainer/VignetteSoftnessSlider
@onready var edge_distortion_slider: HSlider = $VBoxContainer/EdgeDistortionSlider
@onready var distortion_power_slider: HSlider = $VBoxContainer/DistortionPowerSlider
...
func _ready() -> void:
	...
	# Optional: Load current values from the material
